<br></br><br></br><br></br><br></br><div class="container">
	<div class="row mt-4">
		<div class="col">
			<div class="card">
				<h5  class="card-header">Pembayaran Sukses</h5>	
				<div class="card-body">
					<h4><strong>Nomor Order : <?= $content['invoice'] ?></strong></h4>
					<p>Terima kasih telah berbelanja di toko kami.</p>
					<br>
					<p>Silahkan lakukan pembayaran dengan prosedur sebagai berikut :</p>
					<ol>
						<li>Lakukan pembayaran ke rekening <strong>DANA 088214820191</strong> An. Muh Faizal Makmur</li>
					...
					<p>Jika sudah melakukan pembayaran, mohon kirimkan bukti transfernya<a href="<?= base_url('myorder/detail/' . $content['invoice']) ?>"> to this link</a></p>
